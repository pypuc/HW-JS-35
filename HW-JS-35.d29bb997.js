...
var _editStudentApiJs = require("./api/editStudentApi.js");
...
document.querySelector("#get-students-btn").addEventListener("click", async ()=>{
    await (0, _getStudentsApiJs.getStudents)();
});
...
function collectInfo(form) {
    form.addEventListener("submit", (e)=>{
        ...
        (0, _addStudentApiJs.addStudent)(student).then(()=>{
            (0, _getStudentsApiJs.getStudents)();
            form.reset();
        });
    });
}
...
document.querySelector("tbody").addEventListener("click", async (e)=>{
    ...
    if (e.target.textContent === "\u041E\u043D\u043E\u0432\u0438\u0442\u0438") {
        ...
        cells[7].innerHTML = `<button class="save-btn">\u{417}\u{431}\u{435}\u{440}\u{435}\u{433}\u{442}\u{438}</button>`;
    }
    if (e.target.classList.contains("save-btn")) {
        ...
        try {
            await (0, _editStudentApiJs.updateStudent)(studentId, updatedStudent);
            await (0, _getStudentsApiJs.getStudents)();
        } catch (error) {
            console.error("\u041F\u043E\u043C\u0438\u043B\u043A\u0430 \u043F\u0440\u0438 \u043E\u043D\u043E\u0432\u043B\u0435\u043D\u043D\u0456:", error);
        }
    }
    if (e.target.textContent === "\u0412\u0438\u0434\u0430\u043B\u0438\u0442\u0438") try {
        await (0, _deleteStudentApiJs.deleteStudent)(studentId);
        await (0, _getStudentsApiJs.getStudents)();
    } catch (error) {
        console.error(error);
    }
...
},{"./api/getStudentsApi.js":"aYu1K","./api/editStudentApi.js":"2twgI","./api/addStudentApi.js":"kE4CZ","./api/deleteStudentApi.js":"4ClS0"}],"aYu1K":[function(require,module,exports,__globalThis) {
...
},{}],"2twgI":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const updateStudent = async (id, student)=>{
    ...
    try {
        return await fetch(`${(0, _configJs.API_URL)}/${id}`, options).then((res)=>res.json());
    } catch (error) {
        console.log(error);
    }
};

},{"../config.js":"8oaOz","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kE4CZ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4ClS0":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const deleteStudent = async (id)=>{
    try {
        return await fetch(`${(0, _configJs.API_URL)}/${id}`, {
            method: "DELETE"
        });
    } catch (error) {
        console.log(error);
...
},{"../config.js":"8oaOz","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["7SvX3","kyksZ"], "kyksZ", "parcelRequire46db", {})

//# sourceMappingURL=HW-JS-35.d29bb997.js.map
